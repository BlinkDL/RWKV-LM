...
M_BSZ="8" # xzl OK for L12 D1024  8GVRAM
# M_BSZ="4" # xzl   
# M_BSZ="1" # xzl     L16 D1024 OOM on quadro4000

# orig
# LR_INIT="6e-4" 
# LR_FINAL="6e-5"
# xzl: belwo is good on 2 gpus
# LR_INIT="1e-4"      # 2e-5 ---> explosion Nan, 4 gpus; 1e-4 nan on 4 gpus; 1e-4 ok on 2 gpus (16x1024); 
LR_INIT="6e-4" 
LR_FINAL="6e-5"

GRAD_CP=1 # 1 => slower, save VRAM; 0 => faster, more VRAM      (#xzl grad checkpoint
...
GPU_PER_NODE=2 # number of GPUs per node            xzl: more GPUs --> need lower LR otherwise NaN??
#
...
#  --strategy "ddp" \
# --precision bf16      # xzl: forced to use. cf model.py

# --strategy "ddp" \         # xzl complains about bf16 support (amp