...
os.environ[
    "RWKV_FLOAT_MODE"
] = "bf16"  # 'bf16' (stable) or 'fp16' (will overflow after training a large model for very long. can be solved in the future)
...
print("\nRWKV-train output")
out = (
    model_train.forward(torch.tensor([ctx]).cuda())[0][0].detach().cpu().float().numpy()
)
print(out, "\n")
