...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    m.def("forward", &forward, "RWKV tmix value residual gate forward v3 (bf16)");
    m.def("backward", &backward, "RWKV tmix value residual gate backward v3 (bf16)");
}
...
TORCH_LIBRARY_IMPL(rwkv7_tmix_vres_gate_bf16_v3, CUDA, m) {
