...
if [ "$(uname)" == "Darwin" ]; then
    ...
    --accelerator mps --precision fp32 --grad_cp $GRAD_CP --enable_progress_bar True --ds_bucket_mb $DS_BUCKET_MB \
    --svdfac $SVDFAC \
    ...
    # --- Linux ------ 
    GRAD_CP=1 # (deepspeed) 1 => slower, save VRAM; 0 => faster, more VRAM, 
