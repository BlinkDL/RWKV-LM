...
class RWKV_Tmix_x060(MyModule):
    def __init__(self, args, layer_id):
        ...
        with torch.no_grad():
            ...
            self.time_maa_w1 = nn.Parameter(torch.empty(args.n_embd, TIME_MIX_EXTRA_DIM*5).uniform_(-0.01, 0.01))
            self.time_maa_w2 = nn.Parameter(torch.zeros(5, TIME_MIX_EXTRA_DIM, args.n_embd))
            ...
            self.time_decay_w1 = nn.Parameter(torch.empty(args.n_embd, TIME_DECAY_EXTRA_DIM).uniform_(-0.01, 0.01))
            self.time_decay_w2 = nn.Parameter(torch.zeros(TIME_DECAY_EXTRA_DIM, args.dim_att))
